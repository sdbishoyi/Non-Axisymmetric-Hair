...
real_infield = infield_data(:,4);
imag_infield = infield_data(:,5);
real_der_infield = der_infield_data(:,4);
imag_der_infield = der_infield_data(:,5);

time_outfield = outfield_data(:,1);
real_outfield = outfield_data(:,4);
imag_outfield = outfield_data(:,5);
real_der_outfield = der_outfield_data(:,4);
imag_der_outfield = der_outfield_data(:,5);
...
real_infield = infield_data(1:51000,4);
imag_infield = infield_data(1:51000,5);
real_der_infield = der_infield_data(1:51000,4);
imag_der_infield = der_infield_data(1:51000,5);

time_outfield = outfield_data(1:51000,1);
real_outfield = outfield_data(1:51000,4);
imag_outfield = outfield_data(1:51000,5);
real_der_outfield = der_outfield_data(1:51000,4);
imag_der_outfield = der_outfield_data(1:51000,5);
...
plot(log10(time_infield_11(end-52647:end)),-1.0.*log10(time_infield_11(end-52647:end)) - 0.4,'k--','LineWidth',2)
hold off
xlim([2.4,3.4])
ylim([-4.5,-1.5])
%ylim([])
...
%ilename = fullfile('../plots_l3m2', 'bbscalar_vs_t_all.pdf');
%filename = fullfile('../plots_l3m2', 'bbscalar_vs_t_all.png');
filename = fullfile('../plots_l3m2', 'bbscalar_vs_t_all.fig');
saveas(gcf,filename);