...
plot(log10(time_infield_12),log10(abs(bbscalar_12)),'-*','LineWidth',0.5)
plot(log10(time_infield_13),log10(abs(bbscalar_13)),'-.','LineWidth',2)
plot(log10(time_infield_14),log10(abs(bbscalar_14)),':','LineWidth',2)
plot(log10(time_infield_11(end-48647:end)),-1.0.*log10(time_infield_11(end-48647:end)) + 0.75,'k--','LineWidth',2)
hold off
xlim([1,3.5])
%ylim([])
...
filename = fullfile('figures', 'bbscalar_vs_t_all.pdf');
%filename = fullfile('figures', 'bbscalar_vs_t_all.fig');
%filename = fullfile('figures', 'bbscalar_vs_t_all.fig');
saveas(gcf,filename);